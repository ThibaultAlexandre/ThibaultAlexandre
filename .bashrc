...
alias gnw="cd ~/Documents/code/net-worth; git status"
alias gat="cd ~/Documents/code/atlas; git status"
alias gvan="cd ~/Documents/code/vanishing_correction; git status"
alias sagelab="/usr/local/bin/sage -n jupyterlab"
alias yolo="claude --allow-dangerously-skip-permissions"
alias cyolo="codex --dangerously-bypass-approvals-and-sandbox"
